...
local COMMANDS = {
  [""] = function()
    if SYNDICATOR_335 and Syndicator335Compat and Syndicator335Compat.OpenOptionsCategory then
      Syndicator335Compat.OpenOptionsCategory(Syndicator.OptionsCategory and Syndicator.OptionsCategory:GetID() or "Syndicator")
    elseif Settings and Settings.OpenToCategory then
      Settings.OpenToCategory(Syndicator.OptionsCategory:GetID())
    end
  end,
