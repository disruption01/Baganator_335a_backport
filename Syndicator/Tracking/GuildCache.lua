...
function SyndicatorGuildCacheMixin:OnLoad()
  if SYNDICATOR_335 then
    FrameUtil.RegisterFrameForEvents(self, {"GUILDBANKFRAME_OPENED", "GUILDBANKFRAME_CLOSED"})
  else
...
function SyndicatorGuildCacheMixin:OnEvent(eventName, ...)
  if SYNDICATOR_335 and eventName == "GUILDBANKFRAME_OPENED" then
  ...
  elseif SYNDICATOR_335 and eventName == "GUILDBANKFRAME_CLOSED" then
