...
-- The specialization API did not exist in Wrath.  These IDs are only used by
-- modern set-bonus searches, so an empty list is the correct 3.3.5 behaviour.
...
if currentClass == nil then
  ...
  currentClass = CLASS_TOKEN_TO_ID[classToken]
end

addonTable.Search.Constants.ClassGear = {}
local classDetails = ClassData[currentClass] or {}
...
Syndicator.Search.Constants = {KeywordGroupOrder = addonTable.Search.Constants.KeywordGroupOrder}
