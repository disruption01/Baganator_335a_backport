...
function BaganatorCustomiseDialogMixin:SetupGeneral()
  ...
  do
    ...
    local tipsRows = {
      MakeTipsRow({
        header = CreateTextureMarkup("Interface\\AddOns\\Baganator\\Assets\\Search.tga", 64, 64, 13, 13, 0, 1, 0, 1) .. "  " .. SEARCH,
      ...
      MakeTipsRow({
        header = CreateTextureMarkup("Interface\\AddOns\\Baganator\\Assets\\Transfer.tga", 64, 64, 13, 13, 0, 1, 0, 1) .. " " .. addonTable.Locales.TRANSFER,
  ...
  do
    ...
    button:SetScript("OnClick", function()
      if SYNDICATOR_335 and Syndicator335Compat and Syndicator335Compat.OpenOptionsCategory then
        Syndicator335Compat.OpenOptionsCategory(Syndicator.OptionsCategory and Syndicator.OptionsCategory:GetID() or SYNDICATOR_L_SYNDICATOR)
  ...
  addonTable.Compatibility.SetEnabled(profileDropdown.DropDown, not InCombatLockdown())
  frame:RegisterEvent("PLAYER_REGEN_DISABLED")
  frame:RegisterEvent("PLAYER_REGEN_ENABLED")
  frame:SetScript("OnEvent", function(_, eventName)
    addonTable.Compatibility.SetEnabled(profileDropdown.DropDown, eventName == "PLAYER_REGEN_ENABLED")
  end)
...
function BaganatorCustomiseDialogMixin:SetupTheme()
  ...
  addonTable.Compatibility.SetEnabled(allFrames[1].DropDown, not InCombatLockdown())
  frame:RegisterEvent("PLAYER_REGEN_DISABLED")
  frame:RegisterEvent("PLAYER_REGEN_ENABLED")
  frame:SetScript("OnEvent", function(_, eventName)
    addonTable.Compatibility.SetEnabled(allFrames[1].DropDown, eventName == "PLAYER_REGEN_ENABLED")
  end)
