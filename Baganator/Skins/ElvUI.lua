...
local skinners = {
  ...
  ScrollButton = function(button, tags)
    if button.ClearNormalTexture then button:ClearNormalTexture() elseif button.GetNormalTexture and button:GetNormalTexture() then button:GetNormalTexture():SetTexture(nil) end
