...
function addonTable.SingleViews.SetupCollapsingBagSection(layouts, info, bagIDs)
  ...
  -- Pooled/collapsible buttons can return with the icon hidden by a previous
  -- 3.3.5 visual cleanup. Always restore the special-container glyph (notably
  -- the keyring icon) whenever this section is configured.
  layouts.button.Icon:SetAlpha(1)
  layouts.button.Icon:Show()
